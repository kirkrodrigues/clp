...
namespace streaming_compression { namespace gzip {
    ...
    public:
        ...
        public:
            ...
            const char* what () const noexcept override {
                return "streaming_compression::gzip::Decompressor operation failed";
            }
        };
    ...
    private:
        ...
        enum class InputType {
            NotInitialized,    // Note: do nothing but generate an error to prevent this required parameter is not initialized properly
            CompressedDataBuf,
        ...
        // Methods
        /**
         * Reset streaming decompression state so it will start decompressing from the beginning of the stream afterwards
         */
        void reset_stream ();
        ...
        z_streamp m_decompression_stream;
        ...
        const char* m_compressed_stream_block;
