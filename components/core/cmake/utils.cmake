set(SOURCE_FILES_get-float-vars
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/src/MessageParser.hpp
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/src/TimestampPattern.cpp
        ${CMAKE_CURRENT_SOURCE_DIR}/src/TimestampPattern.hpp
        ${CMAKE_CURRENT_SOURCE_DIR}/src/Utils.cpp
        ${CMAKE_CURRENT_SOURCE_DIR}/src/Utils.hpp
        ${CMAKE_CURRENT_SOURCE_DIR}/src/utils/get_float_vars/CommandLineArguments.cpp
        ${CMAKE_CURRENT_SOURCE_DIR}/src/utils/get_float_vars/CommandLineArguments.hpp
        ${CMAKE_CURRENT_SOURCE_DIR}/src/utils/get_float_vars/get-float-vars.cpp
...
add_executable(get-float-vars ${SOURCE_FILES_get-float-vars})
target_link_libraries(get-float-vars
        PRIVATE
        Boost::filesystem Boost::iostreams Boost::program_options
        spdlog::spdlog
        ZStd::ZStd
        )
target_compile_features(get-float-vars
        PRIVATE cxx_std_14
        )
