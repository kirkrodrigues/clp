...
def main(argv):
    ...
    args_parser.add_argument(
        "-f",
        "--files-from",
        help="A file listing all files to decompress.",
    )
    args_parser.add_argument(
        "-d",
        "--extraction-dir",
        metavar="DIR",
        default=".",
        help="Decompress files into DIR",
    )
    ...
    container_config_file_path_on_host = (
        clp_config.logs_directory / container_config_filename
    )
