...
![CLP Benchmark on JSON Logs](img/clp-json-benchmark.png)
![CLP Benchmark on Unstructured Logs](img/clp-unstructured-benchmark.png)
...
![CLP systems overview](img/clp-complete-solution.png)
